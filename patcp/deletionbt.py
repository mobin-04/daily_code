...
1. 1. Start from the root of the tree
...
If the root has only one child, return the child. If the root has two children)
...
4. Otherwise, perform a level order traversal to find the node to be del
...
Find the deepest node in the right subtree (or left subtree). Copy the data of the deepest made to the node to be deleted. Delete the deepest node.
